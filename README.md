...
<kbd> <img width="942" src="Resources/images/gif/python_code_run_pt1.gif" alt="python code part 1" /> </kbd>
...
<kbd> <img width="942" src="Resources/images/gif/python_code_run_pt2.gif" alt="python code part 2" /> </kbd>
...
<kbd> <img width="942" src="Resources/images/gif/python_code_run_pt3.gif" alt="python code part 3" /> </kbd>

## Create the Crowdfunding Database

1. Inspect the four CSV files, and then sketch an ERD of the tables by using `QuickDBDLinks` site.

<kbd> <img width="942" src="Resources/images/png/crowfunding_db_erd_diagram.png" alt="ERD diagram" /> </kbd>
...
<kbd> <img width="942" src="Resources/images/gif/postgres_sql_pt1.gif" alt="postgres sql part 1" /> </kbd>

5. Using the database schema, create the tables in the correct order to handle the foreign keys.

<kbd> <img width="942" src="Resources/images/gif/postgres_sql_pt2.gif" alt="postgres sql part 2" /> </kbd>

6. Verify the table creation by running a `SELECT` statement for each table.

7. Import each CSV file into its corresponding SQL table.

<kbd> <img width="942" src="Resources/images/gif/postgres_sql_pt3.gif" alt="postgres sql part 3" /> </kbd>

8. Verify that each table has the correct data by running a `SELECT` statement for each.

<kbd> <img width="942" src="Resources/images/gif/postgres_sql_pt4.gif" alt="postgres sql part 4" /> </kbd>
